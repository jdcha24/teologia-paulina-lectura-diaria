                        ...
                        <Card className="overflow-hidden">
                            ...
                            <div className="divide-y max-h-96 overflow-y-auto">
                                {filteredStatsUsers.map(u => {
                                    ...
                                    const percent = Math.min(100, Number(((count / 365) * 100).toFixed(1)));
                                    ...
                                    return (
                                        <div key={u.id}>
                                            <div className="p-3 flex items-center justify-between hover:bg-slate-50 cursor-pointer" onClick={() => toggleStatExpand(u.id)}>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span className="text-xs font-bold text-slate-600">{percent.toFixed(1)}%</span>
                        ...
                        <Card className="overflow-hidden">
                            ...
                            <div className="divide-y max-h-96 overflow-y-auto">
                                {filteredStatsReadings.map(day => {
                                    ...
                                    const percent = Number(((count / Math.max(1, allUsers.length)) * 100).toFixed(1));
        ...
        <div className="max-w-3xl mx-auto p-4 space-y-6">
            ...
            <Card className="p-6 bg-white border-none shadow-lg relative overflow-hidden ring-4 ring-sky-50">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex flex-col">
                        ...
                        <span className="text-3xl font-black text-slate-800 flex items-baseline gap-1">
                            {typeof bibleProgress === 'number' ? bibleProgress.toFixed(1) : bibleProgress}<span className="text-sm text-slate-400">%</span>
                        </span>
                    </div>
                ...
                <div className="w-full h-6 bg-slate-100 rounded-full overflow-hidden shadow-inner relative">
                    ...
                    >
                        {bibleProgress > 5 && <span className="text-[10px] font-bold text-white drop-shadow-md">{bibleProgress.toFixed(1)}%</span>}
                    </div>
